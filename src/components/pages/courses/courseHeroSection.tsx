           ...
           <div className="container px-4  mx-auto relative">
              <div className="grid grid-cols-12 lg:grid-cols-12 gap-4 lg:gap-[100px] items-center relative pb-10 ">
                         ...
                         <div  data-aos-delay="5000" data-aos="fade-down" className="col-span-12 z-20 mb-14 lg:mb-0 lg:col-span-7 text-center lg:text-left">
                              <h1 data-aos-delay="5000" data-aos="fade-down" className="text-[#0b0b2c] text-[52px] lg:text-[74px] font-bold font-jakarta leading-[58px] lg:leading-[85px]">Courses</h1>
                              <p data-aos-delay="5000"  className="text-[#69697b] text-[18px] font-normal leading-[1.667em] mb-9 font-jakarta my-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra tristique laoreet ut elementum cras cursus. Morbi morbi at diam.</p>
                       ...
                       <div className="col-span-12 lg:col-span-5 text-center">
                         ...
                         <div data-aos-delay="5000" data-aos="fade-down" className="absolute left-[-389px] top-[-94px]">
                              <Image src={cir1} className="absolute left-[-255px] bottom-[-133px] -z-10"/>
                         </div>
                         <div data-aos-delay="5000" data-aos="fade-down" className="absolute left-[-66px] top-[565px]">
                              <Image src={cir2} className="absolute 2"/>
                         </div>
                         <div data-aos-delay="5000" data-aos="fade-down" className="absolute top-[-3.5rem] right-[23rem] ">
