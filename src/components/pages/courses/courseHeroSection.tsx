           ...
           <div className="container px-4  mx-auto relative">
              <div className="grid grid-cols-12 lg:grid-cols-12 gap-4 lg:gap-[100px] items-center relative pb-10 ">
                         ...
                         <div className="col-span-12 z-20 mb-14 lg:mb-0 lg:col-span-7 text-center lg:text-left">
                              <h1 className="text-[#0b0b2c] text-[52px] lg:text-[74px] font-bold font-jakarta leading-[58px] lg:leading-[85px]">Courses</h1>
                       ...
                       <div className="col-span-12 lg:col-span-5 text-center">
                         ...
                         <div className="absolute top-[24rem] left-[38rem]">
                              <Image src={circle2} className="absolute c2 -z-10"/>
                         </div>
                         <div className="absolute top-[-7rem] right-[-14rem] c33">
