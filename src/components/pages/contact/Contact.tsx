      ...
      <div className="pt-24">
         <div className="container px-4 sm:px-6 mx-auto">
              <div className="text-center">
                   <h1 data-aos-delay="5000" data-aos="fade-down" className='font-jakarta text-[36px] font-bold pb-3'>Need more information?</h1>
                   <p data-aos-delay="5000" data-aos="fade-down" className='font-jakarta text-[#69697b]'>
              ...
              <div>
                    <div className="text-center pt-20 border-b-[1px] border-[#D6DDDA] pb-14">
                          <h1 data-aos-delay="5000" data-aos="fade-down" className='font-jakarta text-[35px] font-bold pb-3'>Frequently Asked Question</h1>
                    </div>
                    <div className="pt-14">
