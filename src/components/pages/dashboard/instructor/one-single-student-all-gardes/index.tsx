                    ...
                    data.data.assignments.map((val:any) => (
                      ...
                      <td className="py-4 px-6 font-nunito">
                        <button
                          ...
                          ${
                            val?.submissions?.filter((val:any) => (
                                val?.student?._id === thisisid  
                            )).length > 0 ? "!text-white bg-[#3A57E8]" :  "text-[#3A57E8] bg-[#EBEEFD]"
                          }   
                        ...
                        >
                          {
                            ...
                            val?.submissions?.filter((val1:any) => (
                                    val1?.student?._id == thisisid
                              )).length > 0 ? "availble" : "missing"
                          }
                          {
                            val?.submissions?.length == 0 && "missing" 
                          }  
                        </button>
                      </td>
                      <td className="py-4 px-6 font-nunito">
