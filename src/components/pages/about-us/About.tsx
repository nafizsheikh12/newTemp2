         ...
         <div>
               <div className='mb-5'>
                        <div className='text-center sm:px-28 xl:px-64 2xl:px-[31rem]'>
                              <h1 data-aos-duration="10000" data-aos="fade-down" className="text-[#0b0b2c] text-[52px] lg:text-[74px] font-bold font-jakarta leading-[58px] lg:leading-[85px]">The mission behind <span className="text-[#3434ff]">Academy.</span></h1>
                              <p data-aos-duration="10000" data-aos="fade-down" className="text-[#69697b] text-[18px] font-normal leading-[1.667em] mb-9 font-jakarta my-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra tristique laoreet ut elementum cras cursus. Morbi morbi at diam.</p>
                              <button data-aos-duration="10000" data-aos="fade-down" className="border-[#3434ff] hover:bg-[#3434ff] transition hover:-translate-y-3 hover:text-white text-[#3434ff] border-2 py-4 uppercase px-8 rounded font-medium text-[16px]">our story</button>
                        </div>
                        <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 px-4 xl:px-24 mt-24 pb-5'>
                              <div data-aos-duration="10000" data-aos="fade-down" className='flex items-end'>
                              ...
                              <div data-aos-duration="10000" data-aos="fade-down" className='flex items-start lg:items-end'>
               ...
               <div className='bg-[#fafafa] py-20'>
                    <div className='container mx-auto sm:px-6 px-4'>
                         <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                                 <div data-aos-duration="10000" data-aos="fade-down" className='flex justify-center flex-col items-center'>
               ...
               <div>
                   <div className='container  mx-auto px-4 sm:px-6 pt-28 pb-24 border-b-[1px] border-[#D6DDDA]'>
                          <div className='flex relative flex-col lg:flex-row gap-16  items-center'>
                              ...
                              <div data-aos-duration="10000" data-aos="fade-down" className=' lg:order-1 z-20'>
               ...
               <div className='py-20 '>
                    <div className='container mx-auto px-4 sm:px-6 border-b-[1px] border-[#D6DDDA] pb-24'>
                          <div data-aos-duration="10000" data-aos="fade-down" className='text-center'>
                                <h1 className='font-jakarta text-[35px] leading-[40px] font-semibold'>The Mission<br/> Behind Academy</h1> 
                          </div>
                          <div data-aos-duration="10000" data-aos="fade-down" className='bg-[#F5F7FF] rounded-2xl mt-14 sm:mx-12'>
                              <Swiper
                                   pagination={{
                                    dynamicBullets: true,
                                  }}
               ...
               <div className='px-4 sm:px-6'>
                    <div className='container mx-auto mb-4'>
                         <div className='text-center'>
                              <h1 data-aos-duration="10000" data-aos="fade-down" className='font-jakarta text-[35px] pb-1 leading-[40px] font-semibold'>Come and Visit Us</h1>
                              <p data-aos-duration="10000" data-aos="fade-down" className='text-[#69697B] font-jakarta mt-2 mb-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat feugiat congue viverra facilisis. Mauris, volutpat mi libero tellus donec amet netus.</p> 
                         </div>
                         <div data-aos-duration="10000" data-aos="fade-down" className='grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 mb-10'>
                         ...
                         <div data-aos-duration="10000" data-aos="fade-down" className='flex justify-center'>
                                       <button 
                   ...
                   <div className="my-12 px-4 sm:px-6 md:my-20  pb-10 bg-[#3434ff] ">
                        <div className="relative container  mx-auto flex-col lg:flex-row text-center lg:text-left flex justify-between pt-24 pb-24 gap-14 ">
                             ...
                             <div className="">
                                 ...
                                 <div data-aos-duration="10000" data-aos="fade-down" className="w-[41%] right-[-3%] top-[82%] absolute lg:w-[17%] lg:top-[54%] lg:right-[0%] 1xl:right-[-3%] 1xl:top-[60%]">
                                       <Image src={grow3}/>
                                 </div> 
                             </div>
                        </div>
               ...
               <div className='px-4 sm:px-6'>
                     <div className='container mx-auto'>
                           <div className='flex flex-col lg:flex-row lg:justify-between lg:items-center'>
                                <div>
                                     <h2 data-aos-duration="10000" data-aos="fade-down" className='font-jakarta text-[38px] pb-1 leading-[40px] font-bold'>Meet Our Teachers</h2>
                                     <p data-aos-duration="10000" data-aos="fade-down" className='text-[#69697B] font-jakarta mt-2 mb-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate</p>
                                </div>
                                <div>
                                     <button data-aos-duration="10000" data-aos="fade-down" className="border-[#3434ff] hover:bg-[#3434ff] transition hover:-translate-y-3 hover:text-white text-[#3434ff] border-2 py-4 uppercase px-8 rounded font-medium text-[16px]">
                                          All Teachers
                                     </button>
                                </div>
                           </div>
