...
const BootCampsCard = ({
  ...
  const {
    user: { roles,email, studentType },refresh
              ...
              <div>
                   ...
                   <div className="flex justify-between items-center">
                       ...
                       <div className="flex items-center gap-2">
                             ...
                             <div>
                                 <span className="font-jakarta font-semibold text-[16px]">{numberOfLectures} Lectures</span>
                             </div>
                       </div>
                   </div>
                   <div className="flex justify-between items-center border-t-2 mt-5 border-[#CECECE] pt-5">
                          <div className="flex justify-between gap-2 items-center">
                                  <ReactStar   size={24} value={ratingsAverage} edit={false} half={true} />
                                  <span className="text-[#8A92A6] font-semibold font-jakarta">{ratingsAverage}</span>
                          </div>
                          <div>
                               {
